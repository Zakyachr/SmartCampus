      ...
      <nav className="flex-1 px-4 py-6 space-y-1">
        {currentMenu.map((item) => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${isActive ? 'text-white font-semibold' : 'text-[#94A3B8] hover:bg-[#243B45] hover:text-white'}`}
            >
